...
```text
funland/foliospace-library:0.885
```
...
```bash
docker pull funland/foliospace-library:0.885
```
...
services:
  foliospace-library:
    image: funland/foliospace-library:0.885
    ports:
      - "8080:8080"
    volumes:
      - ./data/config:/config
...
```text
/install-mcp.sh
/releases/foliospace-mcp_0.885_darwin_arm64.tar.gz
/releases/foliospace-mcp_0.885_darwin_amd64.tar.gz
/releases/foliospace-mcp_0.885_linux_arm64.tar.gz
/releases/foliospace-mcp_0.885_linux_amd64.tar.gz
...
/Users/deadseafu/Documents/FolioSpaceReader/dist/releases/foliospace-mcp_0.885_darwin_arm64.tar.gz
/Users/deadseafu/Documents/FolioSpaceReader/dist/releases/foliospace-mcp_0.885_darwin_amd64.tar.gz
/Users/deadseafu/Documents/FolioSpaceReader/dist/releases/foliospace-mcp_0.885_linux_arm64.tar.gz
/Users/deadseafu/Documents/FolioSpaceReader/dist/releases/foliospace-mcp_0.885_linux_amd64.tar.gz
```

Maintainer build command:

```bash
VERSION=0.885 ./scripts/build-mcp-release.sh
```
...
| `screenshots/video-library.png` | Video library with custom thumbnails, placeholders, and playback mode labels. | Show 0.885 video catalog. |
...
```text
0.885 manifest list: pending GitHub Actions release
...
- Whether Docker Hub is the only public distribution channel for 0.885.
